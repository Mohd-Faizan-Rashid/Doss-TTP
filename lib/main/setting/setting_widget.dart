                ...
                children: [
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent(
                            'SETTING_PAGE_Container_y84fdd07_ON_TAP');
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent(
                            'SETTING_PAGE_Container_x1ewvw6b_ON_TAP');
                        logFirebaseEvent('Container_navigate_to');
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent(
                            'SETTING_PAGE_Container_j62jpwl2_ON_TAP');
                  ...
                  Row(
                    ...
                    children: [
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent('SETTING_PAGE_LOGOUT_BTN_ON_TAP');
