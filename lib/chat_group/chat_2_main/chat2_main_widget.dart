                        ...
                        children: [
                          Padding(
                            ...
                            child: FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'CHAT_2_MAIN_arrow_back_rounded_ICN_ON_TA');
                          ...
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                0.0, 8.0, 16.0, 8.0),
                            child: FlutterFlowIconButton(
                              borderColor: const Color(0xFFEE7800),
                              borderRadius: 12.0,
                              borderWidth: 1.0,
                              buttonSize: 40.0,
                              fillColor: const Color(0x7EFF5300),
                              icon: Icon(
                                Icons.add_comment,
                                color: FlutterFlowTheme.of(context).primaryText,
                                size: 24.0,
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'CHAT_2_MAIN_PAGE_add_comment_ICN_ON_TAP');
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  FFLocalizations.of(context).getText(
                    'n7tgdydv' /* Below are your chats and group... */,
                  ),
                      ...
                      itemBuilder: (context, listViewIndex) {
                        ...
                        return Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'CHAT_2_MAIN_Container_y3qg4tia_ON_TAP');
