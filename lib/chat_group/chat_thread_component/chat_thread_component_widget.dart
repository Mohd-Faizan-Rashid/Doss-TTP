                    ...
                    return Container(
                      ...
                      child: wrapWithModel(
                        ...
                        child: ChatThreadUpdateWidget(
                          key: Key(
                            'Key4ju_${listViewChatMessagesRecord.reference.id}',
                          ),
                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  child: FlutterFlowIconButton(
                                    borderColor: const Color(0xFFFF5300),
                                    borderRadius: 20.0,
                                    borderWidth: 2.0,
                                    buttonSize: 40.0,
                                ...
                                child: SizedBox(
                                  ...
                                  child: TextFormField(
                                    ...
                                    onFieldSubmitted: (_) async {
                                      logFirebaseEvent(
                                          'CHAT_THREAD_COMPONENT_TextField_b4mpy6e9');
                                      logFirebaseEvent(
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: FlutterFlowIconButton(
                                    ...
                                    borderWidth: 1.0,
                                    buttonSize: 40.0,
                                    fillColor: const Color(0x6AA44F25),
                                    icon: const Icon(
                                      Icons.send_rounded,
