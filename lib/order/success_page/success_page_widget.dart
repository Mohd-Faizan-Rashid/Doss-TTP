                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: const Color(0x5D5FFF00),
                          shape: BoxShape.circle,
                          border: Border.all(
                            color: const Color(0x9C5FFF00),
                            width: 2.0,
                          ),
                        ),
                      ...
                      Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'f5144hg5' /* you can now cancel this page */,
                          ),
                          textAlign: TextAlign.center,
                          style:
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'SUCCESS_PAGE_PAGE_VIEW_ORDERS_BTN_ON_TAP');
