...
import 'buy_address_widget.dart' show BuyAddressWidget;
import 'package:expandable/expandable.dart';
import 'package:flutter/material.dart';

class BuyAddressModel extends FlutterFlowModel<BuyAddressWidget> {
  ...
  String? _cityControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'ihwievrv' /* Please enter your city */,
      );
    }
