...
import '/order/empty_state_dynamic/empty_state_dynamic_widget.dart';
...
class _CartOrderHistoryWidgetState extends State<CartOrderHistoryWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'cart_OrderHistory'});
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'h5mebt3f' /* Below are your most recent ord... */,
                              ),
                              ...
                              itemBuilder: (context, _, listViewIndex) {
                                ...
                                return Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'CART_ORDER_HISTORY_listContainer_ON_TAP');
                                      logFirebaseEvent(
