...
class CartAddressWidget extends StatefulWidget {
  ...
  @override
  State<CartAddressWidget> createState() => _CartAddressWidgetState();
}
...
class _CartAddressWidgetState extends State<CartAddressWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'cart_address'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('CART_ADDRESS_cart_address_ON_INIT_STATE');
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('CART_ADDRESS_arrow_back_rounded_ICN_ON_T');
                        ...
                        children: [
                          Padding(
                            ...
                            child: FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'CART_ADDRESS_home_rounded_ICN_ON_TAP');
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'CART_ADDRESS_Container_lk7ip3yl_ON_TAP');
                          ...
                          child: Column(
                            ...
                            children: [
                                  ...
                                  children: [
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'usq582ts' /* Choose a Shipping Address */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .headlineSmall
                                              .override(
                                    ...
                                    FlutterFlowIconButton(
                                      ...
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'CART_ADDRESS_PAGE_add_ICN_ON_TAP');
                                        // togglevalue
                                        logFirebaseEvent(
                                          ...
                                          child: ExpandablePanel(
                                            ...
                                            collapsed: Container(
                                              ...
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'aa0o0iy8' /* Enter your address below */,
                                                ),
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .labelMedium
                                            ...
                                            expanded: Column(
                                              ...
                                              children: [
                                                Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'vgxrsprq' /* Please enter the information b... */,
                                                  ),
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '569e47qa' /* Or choose an address below. */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'CART_ADDRESS_SAVE_AND_CONTINUE_BTN_ON_TA');
                                  if (!(_model.selectedAddress != null)) {
                                    ...
                                    // addAddressToUser
                                    logFirebaseEvent('Button_addAddressToUser');
                                    ...
                                    await showModalBottomSheet(
                                      ...
                                      builder: (context) {
                                        return Padding(
                                          ...
                                          child: const CodOnlinepayWidget(),
                                        );
                                      },
                                    ).then((value) => safeSetState(() {}));
                                  } else {
                                    // showErrorMessage
                                    logFirebaseEvent('Button_showErrorMessage');
